...
export default function StudentOrganizationPage() {
  ...
  if (loading) return <AppShell><p className="text-zinc-500">Loading...</p></AppShell>
  if (!org) return <AppShell><p className="text-zinc-500">Organization not found.</p></AppShell>

  return (
    <AppShell>
      {/* Hero / Info */}
      <div className="bg-white rounded-xl border border-zinc-200 p-6 mb-8 flex items-start gap-6">
        {org.logo_url && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-10">
          ...
          <section>
            ...
            {announcements.length === 0 ? <p className="text-zinc-500 text-sm">No announcements yet.</p> : (
          ...
          <section>
            ...
            {events.length === 0 ? <p className="text-zinc-500 text-sm">No upcoming events.</p> : (
              <ul className="space-y-4">
                {events.map(e => (
