export const theme = {
  navBg: 'linear-gradient(to right, #380111, #8C1D40)',
  pageBg: 'min-h-screen bg-zinc-50',
  nav: 'flex items-center justify-between px-8 py-4 shadow-md',
  navLink: 'text-white/70 hover:text-white',
  navLinkActive: 'text-white font-semibold',
  heading: 'text-4xl font-bold text-[#8C1D40]',
